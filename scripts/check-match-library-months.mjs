...
const checks = [
  ...
  ['Filtri nascondono mesi senza risultati', controller.includes('month.hidden = visibleCards.length === 0')],
  ['Filtri aggiornano conteggio mensile', controller.includes("count.textContent = String(visibleCards.length)")],
  ['Mese con risultati filtrati viene aperto', controller.includes('month.open = true')],
  ...
  ['Ricerca competizione canonica evita collisione con nomi avversari', controller.includes("canonicalCompetitionQuery") && controller.includes("cardCompetition === canonicalCompetitionQuery")],
  ['Contatore globale segue i risultati visibili', controller.includes("data-match-library-visible-count") && view.includes("data-match-library-visible-count")],
