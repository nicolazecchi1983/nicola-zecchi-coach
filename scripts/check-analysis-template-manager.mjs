...
const checks=[
 ...
 ['manager preserves set-piece direction metadata',view.includes('data-template-manager-subsection-direction')&&view.includes('data-template-manager-new-direction')&&view.includes('MATCH_ANALYSIS_SET_PIECE_DIRECTIONS')],
