...
const checks = [
  ...
  ['Compact desktop behavior is retained in canonical owner', appShell.includes('@media (max-width: 1100px) and (min-width: 761px)')],
  ['Dedicated mobile navigation still hides desktop sidebar', responsive.includes('.sidebar {\n    display: none;') && responsive.includes('.mobile-navigation')],
