...
const checks=[
 ...
 ['bulk helper reuses canonical update',events.includes('const setAllCallups = (checked)')&&events.includes('check.checked = checked')&&events.includes('updateCallups({ dirty: true })')],
