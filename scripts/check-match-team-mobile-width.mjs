...
const checks = [
  ...
  ['captain and vice have explicit premium role labels', view.includes('class="leadership-role-label">Capitano</span>') && view.includes('class="leadership-role-label">Vice</span>') && view.includes('class="leadership-role-badge" aria-hidden="true">C</span>') && view.includes('class="leadership-role-badge" aria-hidden="true">VC</span>')],
