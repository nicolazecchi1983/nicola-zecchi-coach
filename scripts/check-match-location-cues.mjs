...
const checks = [
  ...
  ['Match Library usa un solo summary owner negli scope', !library.includes('match-library-heading-meta') && library.includes('match-library-scopes') && library.includes('data-match-library-visible-count')],
  ...
  ['Match Library scope active state resta nel domain owner', libraryCss.includes('.match-library-scope[aria-pressed="true"]')],
