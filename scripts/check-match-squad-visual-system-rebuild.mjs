...
const checks = [
  ...
  ['leadership uses a dedicated premium row family inside lineup', css.includes('.leadership-control {') && css.includes('.leadership-role-badge') && css.includes('.leadership-control select {')],
  ['leadership roles expose canonical C and VC premium badges', view.includes('class="leadership-role-badge" aria-hidden="true">C</span>') && view.includes('class="leadership-role-badge" aria-hidden="true">VC</span>') && css.includes('.leadership-role-badge {')],
