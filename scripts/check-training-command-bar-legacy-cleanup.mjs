...
const checks = [
  ...
  ['canonical mobile owner exists', owner.includes('R2.6T — TRAINING COMMAND BAR SINGLE OWNER · CLUSTER 8') && owner.includes('.ts-manual-editor .ts-command-actions') && owner.includes('grid-template-columns: auto')],
