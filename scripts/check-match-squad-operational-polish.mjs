...
const checks = [
  ...
  ['leadership has its own structural group', view.includes('squad-command-leadership') && view.includes('data-squad-command-leadership')],
  ...
  ['mobile command groups collapse to one column', css.includes('@media (max-width: 760px)') && css.includes('.squad-command-primary,')],
