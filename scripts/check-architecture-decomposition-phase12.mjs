...
const checks=[
 ['Training Draft/Voice physically extracted',heavy.includes("import('../modules/training/events/trainingDraftAndVoiceEvents.js')")&&!app.includes('async function wireTrainingDraftAndVoiceEvents()')],
 ['Async initialization preserved',app.includes('await heavyBinders.wireTrainingDraftAndVoiceEvents({')],
 ...
 ['Controller remains composition root',app.includes('heavyBinders.wireTrainingDraftAndVoiceEvents({')&&app.includes('FormDataCtor: FormData')],
