...
const leadership = view.indexOf('data-squad-command-leadership')
...
const checks = [
  ...
  ['command precedes the operational core and bench', command >= 0 && leadership > command && master > leadership && bench > master],
  ['configuration and leadership are structurally separate rows', view.includes('data-squad-command-primary') && view.includes('data-squad-command-leadership')],
  ...
  ['leadership owns two equal full-width fields', css.includes('repeat(2, minmax(320px, 1fr))') && css.includes('.leadership-control select')],
