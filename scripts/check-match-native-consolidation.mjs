...
const checks = [
  ...
  ['Materiali studio sono collezione aggiungibile', studyView.includes("'data-study-toggle-form': 'asset'") && studyView.includes('data-study-upload-form="asset"')],
  ['Link studio sono collezione aggiungibile', studyView.includes("'data-study-toggle-form': 'link'") && studyView.includes('data-study-link-form')],
