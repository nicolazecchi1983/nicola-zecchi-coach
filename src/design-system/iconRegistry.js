export function icon(name) {
  const icons = {
    ...
    'link': '<path d="M10 14l4-4"></path><path d="M8 17H6a4 4 0 0 1 0-8h3"></path><path d="M16 7h2a4 4 0 1 1 0 8h-3"></path>',
    'external-link': '<path d="M14 5h5v5"></path><path d="M10 14l9-9"></path><path d="M19 13v6H5V5h6"></path>',
    'replace': '<path d="M4 7h12l-3-3"></path><path d="M20 17H8l3 3"></path><path d="M13 4l3 3-3 3"></path><path d="M11 20l-3-3 3-3"></path>',
    ...
    goal: '<circle cx="12" cy="12" r="9"/><path d="m12 7 3 2-1 4h-4L9 9z"/><path d="M5.5 10 9 9M15 9l3.5 1M10 13l-2 4M14 13l2 4"/>',
    card: '<rect x="6" y="3" width="12" height="18" rx="2"/><path d="M9 7h6M9 11h6"/>',
